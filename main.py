...
conn = sqlite3.connect("D:\Store management\Store-Management-Software-SC-C-\Store Management Software\Database\store.db")
c = conn.cursor()
...
class Application:
    def __init__(self, master, *args, **kwargs):
        ...
        # components
        self.heading = Label(self.left, text="Zaayn Store ", font=('arial 40 bold'), bg='white')
